...
export const StaggeredMenu = ({
  ...
  logoUrl,
  logoText = '',
  menuButtonColor = '#8C7E6E',
  openMenuButtonColor = '#1A1714',
  accentColor = '#C94A2A',
  ...
  // Close on same-page anchor navigation
  React.useEffect(() => {
  ...
  const prelayerColors = (() => {
    const raw = colors && colors.length ? colors.slice(0, 4) : ['#8C7E6E', '#2A4A3E'];
    const arr = [...raw];
